...
public class BinaryTree {
        ...
        private static TreeNode add(TreeNode t, int pos, ArrayList preorder, ArrayList inorder){
        	if(t == null){
        ...
        private static boolean isCompletelyBalanced(TreeNode t){
        	...
        	return isCompletelyBalanced(t.myLeft) && isCompletelyBalanced(t.myRight)
        ...
        private TreeNode fibTreeHelper (int n) {
        	...
        	return new TreeNode(new Integer(((Integer) left.myItem).intValue()+((Integer) right.myItem).intValue()),
        			left, right);
        ...
        private static void optimizeHelper(TreeNode cur){
        	int left, right;
        	if(cur.myLeft == null){ // nodes in expression tree must either have 0 or 2 children so checking only the left node is sufficient
        		return;
        	}
