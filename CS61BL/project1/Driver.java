...
public class Driver {
	...
	public static void main(String[] args) {
		...
		BufferedReader playerMoves = new BufferedReader(new InputStreamReader(
				System.in));
		Display myDisplay = new Display(myBoard);
		while (true) {
			// It's the player's turn to move, playing RED.
			// There has to be an uncolored connector, since it's the user's
			// turn
			...
			if (myBoard.colorOf(cnctr) == Color.RED
					|| myBoard.colorOf(cnctr) == Color.BLUE) {
				System.out.println("ERROR: " + cnctr
